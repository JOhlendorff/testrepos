...
public class FrontControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getAttribute("cmd") == "order"){
            processOrder(request, response);
        }
        
        
        String selection = (String) request.getParameter("searchTitle");
        
        request.setAttribute(selection, "searchString");
        
        
        BookMapper bm = new BookMapper(selection);
        bm.readDb();
        ArrayList<Book> bookList = bm.getBookList();
        request.setAttribute("bookList", bookList);
        //request.setAttribute("bookTitle", bookList.get(0).getTitle());
